...
// Ícones de traço (24x24, herdam a cor do texto via currentColor). Mantidos
// inline pra não depender de uma biblioteca externa nem de requisições extras.
const PATHS = {
  dashboard: (
    <>
...
// Decorativos: quem descreve a ação é o texto do botão/link ao lado (ou um
// aria-label no elemento pai), então o SVG fica fora da árvore de acessibilidade.
