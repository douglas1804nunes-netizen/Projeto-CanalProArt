  ...
  return (
    <Routes>
      <Route element={<AppLayout />}>
        ...
        <Route
          path="/trends"
          element={<PlaceholderPage title="Tendências" phase="Fase 6" />}
        />
        <Route
          path="/opportunities"
        ...
        <Route
          path="/videos"
          element={<PlaceholderPage title="Vídeos" phase="Fase 17" />}
        />
        <Route
          path="/youtube"
          element={<PlaceholderPage title="YouTube" phase="Fase 4" />}
        />
        <Route
          path="/settings"
